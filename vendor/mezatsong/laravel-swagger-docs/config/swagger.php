...
return [
     ...
     * API Title
     */
    'title'                     =>  env('APP_NAME', 'Kikae API Documentation'),

    /**
     * API Description
     */
    'description'               =>  env('APP_DESCRIPTION', 'Documentation for the Kikae API'),
     ...
     * API Host
     */
    'host'                      =>  "https://securable.com.ng/tailor-api/public",
