...
An order has been placed with Transaction reference <strong><?php echo e($order->transaction->transaction_id); ?></strong>.

Please find the details of the order below:

<strong>Product name:</strong> <?php echo e($order->product->name); ?><br/>
<strong>Unit Price:</strong> <?php echo e($order->price); ?><br/>
<strong>Number of units:</strong> <?php echo e($order->units); ?><br/>
<strong>Total:</strong> <?php echo e($order->price * $order->units); ?><br/>
<strong>Transaction reference:</strong> <?php echo e($order->transaction->tx_ref); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /var/www/tailor-api/resources/views/emails/orders/placed.blade.php ENDPATH**/ ?>